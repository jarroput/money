...
```elixir
five_eur         = Money.new(5_00, :EUR)             # %Money{amount: 5_00, currency: :EUR}
...
ninety_nine_eur  = Money.subtract(hundred_eur, 1_00)   # %Money{amount: 99_00, currency: :EUR}
shares           = Money.divide(ninety_nine_eur, 2)
[%Money{amount: 49_50, currency: :EUR}, %Money{amount: 49_50, currency: :EUR}]
